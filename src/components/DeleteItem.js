...
export default function DeleteItem() {
    ...
    const OpenVal = () => {
         ...
         return dispatch({ type: "DELETE_INVOICE", payload: {Open:false,Data:data} })
      };
    ...
    const val = items.filter((item) => {
        ...
        dispatch({ type: "DELETE_INVOICE", payload: {Open:false,Data:data} })
         navlink("/");
      };
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={OpenVal}>
        <Transition.Child
          as={Fragment}
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <button
                    ...
                    onClick={() =>dispatch({ type: "DELETE_INVOICE", payload: {Open:false,Data:data} })}
                    ref={cancelButtonRef}
                  >
                    Cancel
                  </button>
